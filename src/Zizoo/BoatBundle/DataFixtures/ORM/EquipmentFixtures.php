...
class EquipmentFixtures implements OrderedFixtureInterface, SharedFixtureInterface, ContainerAwareInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $boatService->createEquipment('battened_mainsail', 'Battened Mainsail', 1);
        $boatService->createEquipment('teak_deck', 'Teak Deck', 2);
