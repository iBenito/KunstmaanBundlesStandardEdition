...
namespace Zizoo\JqGridCustomBundle\Grid;
use Doctrine\ORM\QueryBuilder;
use Symfony\Component\HttpFoundation\Response;
use Doctrine\ORM\Query;
use Zizoo\JqGridCustomBundle\FilterMapper\FilterMapperFactory;
...
class Grid extends GridTools
{
    ...
    /**
     * @var \Zizoo\JqGridCustomBundle\Grid\Grid
     */
    protected $subGrid;
    ...
    public function getGetDataFunction(){
        return $this->getDataFunction;
    }
    
    public function setGetDataFunction($getDataFunction){
    ...
    public function getData()
    {
        if ($this->getDataFunction){
            call_user_func($this->getDataFunction, $this);
            return $this->getDataFunctionResponse;
        } else {
            return $this->getDataOriginal();
        }
    }
    ...
    public function setGetDataFunctionResponse($response){
        $this->getDataFunctionResponse = $response;
    }
}
